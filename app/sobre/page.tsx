...
export default function SobrePage() {
  const teamMembers = [
    ...
    },
    {
      ...
      bio: "Engenheiro civil com vasta experiência em projetos residenciais e comerciais.",
    },
    {
      id: 4,
      name: "Ana Santos",
      ...
      bio: "Responsável por garantir a eficiência nas entregas e gestão de estoque.",
    },
  ]
